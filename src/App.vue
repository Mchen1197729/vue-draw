  ...
  <div class="container">
    <div class="header-container">
      ...
      <div class="down-box">
        ...
        <el-button @click="handleTest" size="small" type="info" plain>测试按钮</el-button>
      </div>
    </div>
        ...
        <div class="tool-tabs-box">
          ...
          <div class="content-box">
            <div class="image-sources-box" v-show="currentTabIndex===0">
              <div class="images-source-item" v-for="source in imageSources" :key="source.name">
    ...
    <el-dialog width="30%" title="创建图元" :visible.sync="dialogFormVisible">
...
export default {
  ...
  methods: {
    ...
    confirmCreateImageSource() {
      ...
      this.imageSources.push({name, url})
      this.form = {name: '', url: ''}
